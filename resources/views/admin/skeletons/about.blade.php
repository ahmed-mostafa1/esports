    ...
    <div class="skeleton-header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-2">
                <a href="{{ route('admin.contents.page', 'about') }}" 
        ...
        <section class="about bg-gray-900 text-white p-8 rounded-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                ...
                <div class="text-center bg-gray-800 p-6 rounded-lg">
                    <div class="mb-4">
                        <img src="{{ asset('img/esport iamges.png') }}" alt="Games" class="w-16 h-16 mx-auto rounded" />
                    </div>
                ...
                <div class="text-center bg-gray-800 p-6 rounded-lg">
                    <div class="mb-4">
                        <img src="{{ asset('img/esport iamges(2).png') }}" alt="Locations" class="w-16 h-16 mx-auto rounded" />
                    </div>
                ...
                <div class="text-center bg-gray-800 p-6 rounded-lg">
                    <div class="mb-4">
                        <img src="{{ asset('img/esport iamges(1).png') }}" alt="Total Prizes" class="w-16 h-16 mx-auto rounded" />
                    </div>
