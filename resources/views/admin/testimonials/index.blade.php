...
<div class="px-6 py-4 space-y-4">
  <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
    <div>
      ...
      <p class="text-sm text-gray-400">Manage the testimonials displayed on the home page.</p>
    </div>
    ...
    <table class="min-w-full divide-y divide-neutral-800 text-sm">
      <thead class="bg-neutral-900 text-gray-300 uppercase tracking-wide text-xs">
        <tr>
          ...
          <th class="px-3 py-3 text-left">Role (EN)</th>
        ...
        @forelse($testimonials as $testimonial)
          <tr data-id="{{ $testimonial->id }}" class="bg-neutral-900/40">
            ...
            <td class="px-3 py-3 text-right space-x-2">
              <a href="{{ route('admin.testimonials.edit', $testimonial) }}" class="inline-flex items-center px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded transition">Edit</a>
        ...
        @empty
          <tr>
            <td colspan="5" class="px-3 py-12 text-center text-gray-400">
              No testimonials yet. <a href="{{ route('admin.testimonials.create') }}" class="text-blue-400 hover:underline">Create the first testimonial</a>.
            </td>
          </tr>
        @endforelse
      </tbody>
