...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
  ...
  <Worksheet ss:Name="Singles">
    <Table ss:ExpandedColumnCount="6">
      ...
      @empty
        <Row>
          <Cell ss:MergeAcross="5"><Data ss:Type="String">No single registrations recorded.</Data></Cell>
        </Row>
      @endforelse
    </Table>
  </Worksheet>
  ...
  <Worksheet ss:Name="Teams">
    <Table ss:ExpandedColumnCount="7">
      ...
      @empty
        <Row>
          <Cell ss:MergeAcross="6"><Data ss:Type="String">No team registrations recorded.</Data></Cell>
        </Row>
      @endforelse
    </Table>
  </Worksheet>
